...
function env() {
  if (process.env.REACT_APP_ENV === "production") {
    ...
    return {
      ...
      browser: browserUrls[requiredNetworkId],
      minReservedAmount: 0.1, //18 wei，The minimum reserved amount of native tokens, so as not to pay the handling fee
      rewardPool: "0x0C9d86dD84F0F46a64bE283ecAeDA5517e1A60Cf",
      connectorFactory: "0x9B666C4B5C7dF17b80f5e2a34f61111dD29720D9",
      bptConnector: "0xd4Dc89F0afaaCFD81292E5A6deA95E7183c8a809", //BptReferralConnector
      bptFactory: "0x0Eb59099deD7D74841AE2d978EAc3378382DBA0C",
      ...
      timelock: "0xF7D742Ae7192EEC19B6A918e5B748ffc308C318e",
      governor: "0x48105A2592315a9ECE7f96dA21837F6a4D2037Ba",
      devFund: "0x17d8A87BF9F3f8ca7469D576d958bE345c1D9D5D",
